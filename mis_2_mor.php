...
date_default_timezone_set('asia/baghdad');
        ...
        $sql = mysqli_query( $link,"SELECT * FROM mis_2_mor WHERE code = '".$_SESSION['std_code']."' LIMIT 1;");
...
<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Computer_Networks" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>شبكات الحاسوب - Computer Networks </B></TD>
</tr>


<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Human_Resourses_Management" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>ادارة الموارد البشرية - Human Resourses Management</B></TD>
</tr>


<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Decision_Support_Systems" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>نظم دعم القرار - Decision Support Systems</B></TD>
</tr>
