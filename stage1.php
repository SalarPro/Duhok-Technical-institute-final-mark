      ...
      <div class="col-12">
        <form class="modal-content animate" action="result.php" method="post">
          <div class="card text-dark bg-light" style="">
            <div class="card-body">
              <div class="mb-3">
                <div class="h1 text-center ">قوناغا ئێکێ</div>
              </div> 
            </div>
          </div>
        </form>
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <select class="form-select " name="class_name" aria-label="Default select example" required>
                  ...
                  <option value="acc_1_mor">ژمێريارى</option>
                  <option value="ba_1_mor">كارگێرى كار</option>
                  <option value="mis_1_mor">سيسته‌مێ زانيارى</option>
                </select>
              </div>
            ...
            <div class="card text-dark bg-light" style="">
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" name="class_name" aria-label="Default select example" required>
                    <option value="" selected>بەشی هەلبژێرە</option>
                    <option value="acc_1_eve">ژمێريارى</option>
                  <option value="ba_1_eve">كارگێرى كار</option>
                  <option value="mis_1_eve">سيسته‌مێ زانيارى</option>
                  </select>
                </div>
                <div class="mt-5 ml-5 mr-5 d-grid gap-2">
                  <input class="btn btn-primary" type="submit" value="دیار کرنا ئەنجامان">
