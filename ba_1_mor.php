...
date_default_timezone_set('asia/baghdad');
        ...
        $sql = mysqli_query( $link,"SELECT * FROM BA_1_MOR WHERE code = '".$_SESSION['std_code']."' LIMIT 1;");
...
<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Column_1_English_Language_I_1" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B> اللغة الانجليزية 1 - English Language I</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Administrative_Correspondence" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>مراسلات ادارية - Administrative Correspondence</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Principles_of_Statistics_1" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>مبادئ الاقتصاد - Principles of Statistics</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Principles_of_Accounting" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>مبادئ المحاسبة - Principles of Accounting</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Websites_Management" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>ادارة المواقع الادارية - Websites Management</B></TD>
</tr>
