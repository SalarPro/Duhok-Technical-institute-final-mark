...
date_default_timezone_set('asia/baghdad');
        ...
        $sql = mysqli_query( $link,"SELECT * FROM ACC_1_MOR WHERE code = '".$_SESSION['std_code']."' LIMIT 1;");
...
<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Kurdology" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>کوردولوجى - Kurdology</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Column_1_English_Language_I" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B> اللغة الانجليزية 1 - English Language I</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Computer_Essentials" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>اساسيات الحاسبة - Computer Essentials</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Column_1_Principles_of_Accounting_I" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>مبادئ المحاسبة 1 - Principles of Accounting I</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Principles_of_Management" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>مبادئ الادارة - Principles of Management</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Column_2_Principles_of_Accounting_II" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>مبادئ المحاسبة 2 - Principles of Accounting II</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Accounting_Readings" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>قراءات محاسبية - Accounting Readings</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Principles_of_Economics" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>مبادئ الاقتصاد - Principles of Economics</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Principles_of_Statistics" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>مبادئ الاحصاء - Principles of Statistics</B></TD>
</tr>

<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Column_2_English_Language_II" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B> اللغة الانجليزية 2 - English Language II</B></TD>
</tr>
