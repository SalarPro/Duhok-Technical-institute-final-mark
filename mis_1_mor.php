...
date_default_timezone_set('asia/baghdad');
        ...
        $sql = mysqli_query( $link,"SELECT * FROM MIS_1_MOR WHERE code = '".$_SESSION['std_code']."' LIMIT 1;");
...
<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Mathmatics" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>  رياضيات - Mathmatics</B></TD>
</tr>
...
<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Management_Information_Systems" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>نظم المعلومات الادارية - Management Information Systems</B></TD>
</tr>


<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Computer_Programming" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>لغة البرمجة - Computer Programming</B></TD>
</tr>
...
<tr  class='active' align='center'>
<TD bgcolor='#CCDDFF' width='50%' ><B>".$myrow[ "Information_Security" ]."</B></TD>
<TD bgcolor='#87AFFF' width='50%' ><B>امن المعلومات - Information Security</B></TD>
</tr>
